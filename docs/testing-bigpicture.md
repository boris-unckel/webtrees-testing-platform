...
*Aktualisiert: 2026-04-06 — Testentwurfsverfahren Plan2-Nachpflege: 7 fehlende Äquivalenzklassen-Einträge ergänzt (G30 UPLOAD_ERR-Codes + PSR-7-Kontext, S52 MapDataSave INSERT/UPDATE-Zustand, P39 $_COOKIE-CLI-Constraint, SEC-UTL01 DataProvider-Batch Content-Type, E07 replacementImageResponse→200-Befund, P40 REQUIRE_APPROVAL-Setup + Guard-Matrix, A11 Masquerade Auth-Branches). Konsistenzabgleich: alle Abdeckungsmatrix-Einträge G30/S52/P38–P41/SEC-UTL01/E01–E08/A01–A11 gegen AP-Dateien geprüft — keine Abweichungen.*
