...
| Teststufe 2 — Komponentenintegrationstest | Alle Feature-Matrix-Integrationstests grün (G01–G04, G07–G10, G12–G16, G24, G26, G29, S01–S03, S05–S08, S10–S12, S19 (inkl. Nachnamen-Collation via handle()), S21, S22, S41, S42, S43, S44, S46, S47, S48, S49, S50, P01–P24, P27–P33, P35, P36, P37, SEC-BOT01); strukturbasierte CRAP-Analyse-Tests grün (G25, G27–G28, S45, P34) |
...
| **Strukturbasiertes Testen (CRAP-Score-Analyse)** | G25, G27 (🚫 EXCLUDED), S45 | Testziel-Auswahl via CRAP-Score (cx² + cx bei 0 % Coverage) aus PHPUnit Clover-XML (`make crap-report`). Schwelle: CRAP > 100 (cx ≥ 10). Tests zielen auf Code-Pfad-Abdeckung (strukturbasiertes Testen, ISTQB), nicht auf fachliche Äquivalenzklassen. Explizit **niedrigere Qualitätsstufe** als spezifikationsbasierte Tests: i. d. R. Smoke-Pfad (200 OK / Redirect) oder Basis-Verhalten ohne vollständige Grenzwert- und Äquivalenzklassen-Abdeckung. Ausgeklammert: DNS-abhängige Zweige (BadBotBlocker), nicht-CLI-Umgebungsprüfungen, externe Dateirechte-Abhängigkeiten. Drei Gruppen: A (CRAP > 1.000), B (300–1.000), C (100–300). Stand 2026-04-05: 43 → 16 Methoden nach Runde 1+2 (27 eliminiert). |
...
|---|---|---|---|---|---|
| **Abgedeckt** (spezifikationsbasiert) | 25 (inkl. G26, G29) | 48 (inkl. S41, S42, S43, S44, S46, S47, S48, S49, S50) | 36 (inkl. P30, P31, P32, P33, P35, P36, P37) | 25 (inkl. SEC-BOT01) | **134** |
| Davon mit Einschränkung (Upstream-Bug) | 1 (G16) | 0 | 0 | 1 (SEC-C03) | **2** |
| Deployment-Empfehlung | 0 | 0 | 0 | 1 (SEC-HDR04) | **1** |
| **Abgedeckt** (strukturbasiert, CRAP-Analyse, niedrigere Qualitätsstufe) | 3 (G25, G27–G28) | 1 (S45) | 1 (P34) | 0 | **5** |
