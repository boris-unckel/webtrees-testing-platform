...
| Teststufe 2 — Komponentenintegrationstest | Alle Feature-Matrix-Integrationstests grün (G01–G04, G07–G10, G12–G16, G24–G26, G29, S01–S03, S05–S08, S10–S12, S19 (inkl. Nachnamen-Collation via handle()), S21, S22, S41–S50, P01–P24, P27–P33, P35, P36, P37, SEC-BOT01); strukturbasierte CRAP-Analyse-Tests grün (G27–G28, S45, P34) |
...
|---|---|---|---|---|---|
| **Abgedeckt** (spezifikationsbasiert) | 26 (inkl. G25, G26, G29) | 49 (inkl. S41–S50) | 36 (inkl. P30, P31, P32, P33, P35, P36, P37) | 25 (inkl. SEC-BOT01) | **136** |
| Davon mit Einschränkung (Upstream-Bug) | 1 (G16) | 0 | 0 | 1 (SEC-C03) | **2** |
| Deployment-Empfehlung | 0 | 0 | 0 | 1 (SEC-HDR04) | **1** |
| **Abgedeckt** (strukturbasiert, CRAP-Analyse, niedrigere Qualitätsstufe) | 2 (G27–G28) | 0 | 1 (P34) | 0 | **3** |
...
*Aktualisiert: 2026-04-04 — G26 (GEDCOM-Export via CLI) von strukturbasiert auf spezifikationsbasiert angehoben. TreeExportCommandIntegrationTest: 2→13 Tests (EP Format×4+1 invalid, EP Privacy×4+1 invalid, Tree-not-found). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag G26. Feature-Matrix, Abdeckungsmatrix, Endekriterien aktualisiert. Gesamtabdeckung: 140 Features (116 spezifikationsbasiert + 23 strukturbasiert).*
*Aktualisiert: 2026-04-04 — G29 (GEDCOM-Bearbeitungsservice) von strukturbasiert auf spezifikationsbasiert angehoben. GedcomEditServiceIntegrationTest: 7→9 Tests (+CONT-Continuation EP2, +Subtag-Expansion EP9). Spec-Korrekturen: EP10 (leerer Input expandiert, kein leerer Return), EP3 als nicht direkt testbar markiert. Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag G29. Feature-Matrix, Abdeckungsmatrix, Endekriterien aktualisiert. Gesamtabdeckung: 141 Features (117 spezifikationsbasiert + 22 strukturbasiert).*
*Aktualisiert: 2026-04-04 — P35 (CLI Benutzer-Verwaltung) von strukturbasiert auf spezifikationsbasiert angehoben. UserEditCommandIntegrationTest: 3→16 Tests (alle 15 Guard-Branches B1–B15, DataProvider für B3/B4/B5). Testentwurfsverfahren: neuer Entscheidungstabellen-Eintrag P35. Feature-Matrix, Abdeckungsmatrix, Endekriterien aktualisiert. Gesamtabdeckung: 142 Features (118 spezifikationsbasiert + 21 strukturbasiert).*
*Aktualisiert: 2026-04-04 — P36 (CLI Einstellungs-Verwaltung) von strukturbasiert auf spezifikationsbasiert angehoben. CliSettingsBatchIntegrationTest: 9→17 Tests (B1/B2 --list-Konflikte, B6 Delete nonexistent, B9 Get nonexistent, B12 same-value Warn, B14 Update, EP11 Tree/User/UserTree not found). Testentwurfsverfahren: neuer Zustandsbasierter-Test-Eintrag P36, CRAP-Zeile korrigiert (P35 entfernt).*
*Aktualisiert: 2026-04-04 — S50 (Hilfetexte) von strukturbasiert auf spezifikationsbasiert angehoben. Neue Klasse HelpTextIntegrationTest: 13 Tests (DataProvider 12 Topics + unknown-Topic EP6/EP7 korrigiert auf 200). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag S50. Abdeckungs-Zusammenfassung konsolidiert: 120 spezifikationsbasiert + 19 strukturbasiert = 139 Features (alle Reklassifizierungen G26/G29/P35/P36/S50 eingerechnet).*
*Aktualisiert: 2026-04-04 — S49 (Medienverwaltungsliste Admin) von strukturbasiert auf spezifikationsbasiert angehoben. ManageMediaDataIntegrationTest: 2→3 Tests (+unused-Branch EP3, JSON-Struktur-Assertions in allen 3 Tests). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag S49. Zusammenfassung: 121 spezifikationsbasiert + 18 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-04 — S42 (Such-HTTP-Handler) von strukturbasiert auf spezifikationsbasiert angehoben. SearchRequestHandlerIntegrationTest: 3→6 Tests (+EP2 Individual-Redirect 302, +EP4 Family-Redirect 302, +EP8 Default-Fallback). Neues Fixture search-redirect-test.ged. Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag S42. Zusammenfassung: 122 spezifikationsbasiert + 17 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-04 — SEC-BOT01 (UA-basierte Bot-Blockierung) von strukturbasiert auf spezifikationsbasiert angehoben (DNS-Branches dauerhaft ausgeklammert). BadBotBlockerIntegrationTest: 3→15 Tests (BAD_ROBOTS DataProvider×5 Kategorien, WP-Pfade DataProvider×4, Cookie-Heuristik EP8/EP9, makeRequest()-Helper). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag SEC-BOT01. Zusammenfassung: 123 spezifikationsbasiert + 16 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — P37 (HTTP Benutzer-Bearbeitung) von strukturbasiert auf spezifikationsbasiert angehoben. Neue Klasse UserEditActionIntegrationTest: 7 Tests (B1 not-found HttpNotFoundException, B5/B6 Duplikat-Email-Redirect, B7/B8 Duplikat-Username-Redirect, B4 Self-Edit-Admin-Guard, B3 Passwort-Update/Kein-Update, EP12 Path-Length-Reset). DB::table-Direktassertion für Path-Length (getUserPreference-Cache-Bypass). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag P37, CRAP-Zeile korrigiert (P37 entfernt). Zusammenfassung: 124 spezifikationsbasiert + 15 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — P30 (Datensätze zusammenführen) von strukturbasiert auf spezifikationsbasiert angehoben. Neue Klasse MergeFactsActionIntegrationTest: 5 Tests (B1/EP2 record-not-found, B3/EP4 same-record, B4/EP5 INDI+SOUR tag-mismatch, B5/EP6 pending-deletion via DB-Insert, EP1 change-Tabellen-Assert für deleteRecord()). Auth::user()-Cache-Problem dokumentiert (kein auto_accept ohne Cache-Invalidierung → change-Tabellen-Assert statt individuals-Assert). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag P30, CRAP-Zeile korrigiert (P30 entfernt → P31–P34). Zusammenfassung: 125 spezifikationsbasiert + 14 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — P31 (Familienmitglieder bearbeiten) von strukturbasiert auf spezifikationsbasiert angehoben. Neue Klasse ChangeFamilyMembersActionIntegrationTest: 5 Tests (EP1 Vater-Austausch, EP2 Mutter-Entfernung, EP3 Kind-Hinzufügen, EP4 Kind-Entfernen, EP5 kein-Änderung=0-change-Einträge). Assertion via change-Tabelle (exists() je betroffenem xref); B7/B8 Datumsreihenfolge ausgeklammert (Pragmatisch C). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag P31, CRAP-Zeile korrigiert (P31 entfernt → P32–P34). Zusammenfassung: 126 spezifikationsbasiert + 13 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — P33 (Stammbaum-Privacy-Einstellungen) von strukturbasiert auf spezifikationsbasiert angehoben. Neue Klasse TreePrivacyActionIntegrationTest: 6 Tests (EP3/EP4 mismatched-arrays→Exception, EP5 tag+xref-Regel, EP6 tag-only-Regel, EP7 xref-only-Regel, EP8 beide-leer→countBefore=countAfter, EP9 HIDE_LIVE_PEOPLE→tree.getPreference). Fix: EP8 nutzt countBefore/After statt 0 (TreeService::create kopiert default_resn von gedcom_id=-1). Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag P33, CRAP-Zeile korrigiert (P33 entfernt → P32, P34). Zusammenfassung: 127 spezifikationsbasiert + 12 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — S48 (Standortdaten-Import Admin) von strukturbasiert auf spezifikationsbasiert angehoben. MapDataImportIntegrationTest: 2→4 Tests (+EP1+EP5 korrektes CSV `;`-Format option=add→DB-Postcondition assertEqualsWithDelta lat/lng; +EP6 Null-Island level=1 (0,0)→gefiltert assertFalse exists). Befund: bisherige Smoke-Tests nutzten falsches `,`-Format→importierten 0 Zeilen; als Fehlerresilienz-Tests behalten. Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag S48, CRAP-Zeile korrigiert (S48 entfernt → S45 allein). Zusammenfassung: 133 spezifikationsbasiert + 6 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — S47 (Interaktiver Stammbaum) von strukturbasiert auf spezifikationsbasiert (Pragmatisch C) angehoben. InteractiveTreeIntegrationTest: 2→3 Tests (getDetails: +assertStringContainsString('X1030'); getIndividuals p-Request: assertIsString→assertNotEmpty+HTML; getIndividuals c-Request: assertIsString→assertNotEmpty+HTML; Docblocks mit EP-Refs). Testentwurfsverfahren: neuer Pragmatisch-C-Eintrag S47, CRAP-Zeile korrigiert (S47 entfernt → S45, S48). Zusammenfassung: 132 spezifikationsbasiert + 7 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — S46 (Homepage-Block-Module) von strukturbasiert auf spezifikationsbasiert (Pragmatisch C) angehoben. BlockModuleIntegrationTest: 10→14 Tests (+DataProvider infoStyles×4: table/tagcloud/list/array via extract($config)). SlideShow: assertIsString→assertNotEmpty. EP2 (AJAX→JSON) gestrichen (loadAjax()=true ist Host-Page-Flag, kein JSON-Branch in getBlock()). Styles-Korrektur: 'cloud'→'tagcloud'. Testentwurfsverfahren: neuer Pragmatisch-C-Eintrag S46, CRAP-Zeile korrigiert (S46 entfernt → S45, S47–S48). Zusammenfassung: 131 spezifikationsbasiert + 8 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — S44 (Report-Parser Erweitert) von strukturbasiert auf spezifikationsbasiert (Pragmatisch C) angehoben. ReportParserGenerateExtendedIntegrationTest: assertIsString→assertNotEmpty+assertStringContainsString('<') für alle 3 Tests (EP1 Vorfahren, EP3 Nachkommen, EP7 Individual+Fakten+Bild). Rekursionsabbruch EP2/EP4 durch Demo-Fixture implizit abgedeckt. Testentwurfsverfahren: neuer Pragmatisch-C-Eintrag S44, CRAP-Zeile korrigiert (S44 entfernt → S45–S48). Zusammenfassung: 130 spezifikationsbasiert + 9 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — Runde 3 (G25+S45) abgeschlossen. G25 (GedcomLoad CLI-Import) von strukturbasiert auf spezifikationsbasiert angehoben: GedcomLoadIntegrationTest 2→8 Tests (EP1 keep_media=0 löscht Media, EP2 keep_media=1 behält Media, EP3 BOM-Strip, EP4 kein-0-HEAD→Fail, EP5 kein-Trailer→Fail, EP6 Complete-View; Fix: gedcom.imported DB-Default=1, Tree::fromDB Re-fetch für EP5). S45 (Report-Primitive PDF/HTML) auf spezifikationsbasiert+strukturbasiert angehoben: ReportHtmlObjectsIntegrationTest 6→13 Tests (fill/border/newline Assertions für TextBox+Cell; Fix: noMarginWidth=200 für X-Pos-Test), ReportPdfObjectsIntegrationTest 7→10 Tests (3 ReportPdfImage-Branch-Tests: line='N' Y-Advance, statisch, CURRENT_POSITION+Kollision). GedcomLoad::handle + ReportPdfImage::render aus CRAP-Liste eliminiert: 43→15 Methoden, Runde 1–3 gesamt 28 eliminiert. Feature-Matrix, Endekriterien, Testentwurfsverfahren, Abdeckungsmatrix aktualisiert. Zusammenfassung: 136 spezifikationsbasiert + 3 strukturbasiert = 139 Features.*
*Aktualisiert: 2026-04-05 — S43 (Report-Generierung HTTP) von strukturbasiert auf spezifikationsbasiert angehoben. ReportIntegrationTest: 5→8 Tests (+EP2 format='PDF'→application/pdf, +EP6 destination='download'→content-disposition:attachment, +B1 unknown-report→redirect). switch($format): default+case'HTML' kombiniert → EP3/EP4 identisch mit EP1, kein eigener Branch. TCPDF: Output('S') via ob_start/ob_get_clean korrekt erfasst. Testentwurfsverfahren: neuer Äquivalenzklassen-Eintrag S43, CRAP-Zeile korrigiert (S43 entfernt → S44–S48). Zusammenfassung: 129 spezifikationsbasiert + 10 strukturbasiert = 139 Features.*
