 ...
 *
 * @see docs/testing-bigpicture-prompt.md S26–S30, AP 5b-2b
 */
...
test.describe('Record Pages', () => {
  test('S26 — source page renders', async ({ page }) => {
  ...
  test('S27 — media page renders', async ({ page }) => {
  ...
  test('S29 — repository page renders', async ({ page }) => {
  ...
  test('S30 — submitter page renders', async ({ page }) => {
