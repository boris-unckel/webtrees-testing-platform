...
/**
 * Authentifizierungs-Konstanten fuer E2E-Tests.
...
/** Test-User-Passwort (User 'test-member', 'test-editor' etc.) */
export const TEST_USER_PASSWORD = requireEnv('WEBTREES_TEST_USER_PASSWORD');
